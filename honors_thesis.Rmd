...
lasso.fit <- train(direction ~ .,
                    ...
                    tuneGrid = lasso.grid)
summary(lasso.fit)
lasso.pred <- predict(lasso.fit, GSPC.train)
table(lasso.pred, GSPC.train$direction)
mean(lasso.pred == GSPC.train$directio)                    
```
...
bestMtry <- tuneRF(GSPC.train[,2:29], GSPC.train$direction, stepFactor = 1.5, improve = 1e-5, ntree = 1000)
